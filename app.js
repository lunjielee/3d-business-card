...
const popLogo = document.querySelector(".pop-logo");
...
const mouseEnter = () => {
  ...
  popLogo.style.transform = "translateZ(50px)";
  profession.style.transform = "translateZ(30px)";
  contacts.style.transform = "translateZ(40px)";

  next.style.transform = "translateX(-50%) translateZ(20px)";
...
const mouseLeave = () => {
  ...
  popLogo.style.transform = "translateZ(0)";
  profession.style.transform = "translateZ(0)";
  contacts.style.transform = "translateZ(0)";

  next.style.transform = "translateX(-50%) translateZ(0)";
